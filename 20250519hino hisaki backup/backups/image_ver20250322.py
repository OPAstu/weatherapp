...
hambarg.title("polowanie") #()はウィンドウのタイトル設定

image_1 = cv2.imread(r"C:\dev\hino hisaki\images\sunny.PNG")
...
white = cv2.imread(r"C:\dev\hino hisaki\images\cloudy.PNG")
#imreadはcv2の画像読み込み機能。()にはファイルの位置と名前を書く
...
moniter = cv2.imread(r"C:\dev\hino hisaki\images\rainy.PNG")
#imreadはcv2の画像読み込み機能。()にはファイルの位置と名前を書く
